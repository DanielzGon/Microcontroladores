...
const int buttonPin = 7;//Define buttonPin no pino digital 7
const int Buzzer = 10;//Define ledPin no pino digital 10
...
void setup()
{
  pinMode(Buzzer , OUTPUT);//Define ledPin (pino 10) como saída
